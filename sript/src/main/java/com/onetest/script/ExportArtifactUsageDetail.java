 ...
 * @date 2021/11/30
 */
public class ExportArtifactUsageDetail {

    public static void main(String[] args) {

        List<ArtifactUsageDetail> all = new ArrayList<>(10000);

        String url = "https://music-ox.hz.netease.com/api/overmindx/artifactdep/list?offset=%s&limit=%s";
        int pageSize = 1000;
        int offset = 0;
        ...
        CsvWriter csvWriter = new CsvWriter(new File("artifact-dep-detail.csv"));
